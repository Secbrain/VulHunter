...
Detailed description can also refer to [ethervm](https://ethervm.io/).

## Opcode.xlsx

The document divides the following opcodes into 9 categories: Compute, Compare, Bit operation, Transaction data, Memory, Call data & Code data, Block data, Jump & Stop and Stack.
