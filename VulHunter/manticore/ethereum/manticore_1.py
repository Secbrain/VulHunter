    ...
    def _compile_through_crytic_compile(filename, contract_name, libraries, crytic_compile_args):
        ...
        try:
            ...
            for compilation_unit in crytic_compile.compilation_units.values():
                print(compilation_unit.filename_to_contracts)
                # print(len(compilation_unit.source_units.values()))
                for source_unit in compilation_unit.source_units.values():
                    # print(list(compilation_unit.source_units.values())[0].contracts_names_without_libraries)
