...
def parse_args():  # pylint: disable=too-many-statements
    ...
    group_misc.add_argument(
        '--cfg-dir',
        help='Set the dir of the ethersolver jar file (default ./main/instance_generates)',
        action='store',
        default='./main/instance_generates'
    )
...
if __name__ == '__main__':
    ...
    if args.train_contracts and args.train_solcversions and args.instance_dir:
        import instance_generates.bytecodes_construction_Ethersolve as bytecodes_construction
        ...
        bytecodes_construction.make_bytecodes_continue2(args.train_contracts, args.train_solcversions, int(args.instance_len), args.tmp_dir, args.instance_dir, args.cfg_dir)
    ...
    for i in range(1):
        ...
        if filetype == 'solidity' and ifmap == 'nomap':
            bytecodes_list_val, contractnames_val, opcodes_lists_val = bytecodes_construction.make_bytecodes_opcodes_for_solidity_file(filepath, version, instance_len, args.tmp_dir, args.cfg_dir)
        elif filetype == 'solidity' and ifmap == 'map':
            bytecodes_list_val, contractnames_val, opcodes_lists_val, pcs_lists_val = bytecodes_construction.make_bytecodes_opcodes_mapping_for_solidity_file(filepath, version, instance_len, args.tmp_dir, args.cfg_dir)
            pc_lists.append(pcs_lists_val)
        elif filetype == 'bytecode':
            bytecodes_list_val, contractnames_val, opcodes_lists_val = bytecodes_construction.make_bytecodes_opcodes_for_binary_file(filepath, instance_len, args.tmp_dir, args.cfg_dir)
        elif filetype == 'opcode':
            bytecodes_list_val, contractnames_val, opcodes_lists_val = bytecodes_construction.make_bytecodes_opcodes_for_opcode_file(filepath, instance_len, args.tmp_dir, args.cfg_dir)
