        ...
        if mode == 'Train':
            ...
            for i in range(len(data_inputs)):
                ...
                for k in range(min(kind_size, len(data_inputs[idx[i]]))):
                    ...
                    self.data.append(data_val.reshape((16, int(data_len/16))))
...
#             nn.BatchNorm2d(256),
        ...
        self.GRU = nn.Sequential(
            nn.GRU(input_size,hidden_size,num_layer,batch_first=True,bidirectional=False) #,bidirectional=True,LSTM
        )
...
#             nn.Linear(4,2), #二分类
        ...
        self.linear1 =  nn.Linear(2*512,2)
