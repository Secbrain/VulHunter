...
def validate_feasibility_instance(opcodes_list, solvers):
    ...
    for solver_val in solvers:
        if solver_val == 'ALL':
            smtsolver = Z3Solver()
            feasibility_result = feasibility_result & smtsolver.check(constraints)
            ...
            smtsolver = Z3Solver()
            feasibility_result = feasibility_result & smtsolver.check(constraints)
        elif solver_val == 'Yices':
            smtsolver = YicesSolver()
            feasibility_result = feasibility_result & smtsolver.check(constraints)
        elif solver_val == 'CVC4':
            smtsolver = CVC4Solver()
            feasibility_result = feasibility_result & smtsolver.check(constraints)
...
if __name__ == '__main__':
    ...
    # opcodes_list = ['PUSH1', '0x80', 'PUSH1', '0x40', 'MSTORE', 'PUSH1', '0x4', 'CALLDATASIZE', 'LT', 'PUSH2', '0x57', 'JUMPI', 'PUSH1', '0x0', 'CALLDATALOAD', 'PUSH29', '0x100000000000000000000000000000000000000000000000000000000', 'SWAP1', 'DIV', 'PUSH4', '0xffffffff', 'AND', 'DUP1', 'PUSH4', '0x5d5549b', 'EQ', 'PUSH2', '0x5c', 'JUMPI', 'DUP1', 'PUSH4', '0x5fd8c710', 'EQ', 'PUSH2', '0x73', 'JUMPI', 'DUP1', 'PUSH4', '0xa9059cbb', 'EQ', 'PUSH2', '0x8a', 'JUMPI', 'JUMPDEST', 'CALLVALUE', 'DUP1', 'ISZERO', 'PUSH2', '0x96', 'JUMPI', 'JUMPDEST', 'POP', 'PUSH2', '0xd5', 'PUSH1', '0x4', 'DUP1', 'CALLDATASIZE', 'SUB', 'DUP2', 'ADD', 'SWAP1', 'DUP1', 'DUP1', 'CALLDATALOAD', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'SWAP1', 'PUSH1', '0x20', 'ADD', 'SWAP1', 'SWAP3', 'SWAP2', 'SWAP1', 'DUP1', 'CALLDATALOAD', 'SWAP1', 'PUSH1', '0x20', 'ADD', 'SWAP1', 'SWAP3', 'SWAP2', 'SWAP1', 'POP', 'POP', 'POP', 'PUSH2', '0x237', 'JUMP', 'JUMPDEST', 'DUP1', 'PUSH1', '0x0', 'DUP1', 'CALLER', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'SWAP1', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'PUSH1', '0x0', 'SHA3', 'SLOAD', 'LT', 'ISZERO', 'ISZERO', 'PUSH2', '0x317', 'JUMPI', 'DUP1', 'PUSH1', '0x0', 'DUP1', 'DUP5', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'SWAP1', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'PUSH1', '0x0', 'SHA3', 'PUSH1', '0x0', 'DUP3', 'DUP3', 'SLOAD', 'ADD', 'SWAP3', 'POP', 'POP', 'DUP2', 'SWAP1', 'SSTORE', 'POP', 'DUP1', 'PUSH1', '0x0', 'DUP1', 'CALLER', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'PUSH20', '0xffffffffffffffffffffffffffffffffffffffff', 'AND', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'SWAP1', 'DUP2', 'MSTORE', 'PUSH1', '0x20', 'ADD', 'PUSH1', '0x0', 'SHA3', 'PUSH1', '0x0', 'DUP3', 'DUP3', 'SLOAD', 'SUB', 'SWAP3', 'POP', 'POP', 'DUP2', 'SWAP1', 'SSTORE', 'POP', 'JUMPDEST', 'POP', 'POP', 'JUMP']
    opcodes_lists = [
    ...
    for i in range(len(opcodes_lists)):
        print(i, validate_feasibility_instance(opcodes_lists[i], ['Z3']))
        # break

# # # smtsolver.check(constraints)
...
# cs.add(b == 10)
# print(smtsolver.check(cs))
# print(smtsolver.get_value(cs, c))

# sol = smtsolver.get_value(cs, mm, sender)
# print(sol)

# sol = smtsolver.get_all_values(cs, x, maxcnt=5, silent=True) #for
# print(sol)
